...
def join_dams_flowlines(run_name):
    ...
    Returns:
        nabd_nhd_join (pandas.DataFrame): An dataframe with dam and flowline attributes.
    """
    ...
    flowlines = pd.read_csv(gdrive/"NHDPlusNationalData/NHDFlowlines.csv",
                            usecols=['Hydroseq', 'UpHydroseq', 'DnHydroseq',
                                     ...
                                     'FTYPE', 'COMID', 'WKT'])  #all NHD Flowlines
...
def filter_join(nabd_nhd_join, run_name):
    ...
    Parameters:
        nabd_nhd_join (pandas.DataFrame):
            Dataframe containing dam and flowline attributes related by COMID.
            The data was obtained from the 'join_dams_flowlines' function.
