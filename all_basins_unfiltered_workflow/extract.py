...
def join_dams_flowlines(flowlines, run_name, nabd):
    ...
    Parameters:
        ...
        major_basins (list): 
            List of the major U.S. river basins that correspond to the run_name.
            The HUC 2 values listed after the name filter the HUC2 into 
    ...
    if run_name == 'Colorado':
        ...
        colorado = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])| 
        (flowlines['HUC2'] == major_basins[run_name][1])]
    ...
    if run_name == 'Columbia':
        ...
        columbia = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])]
    ...
    if run_name == 'Great Basin':
        ...
        great_basin = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])]
    ...
    if run_name == 'Great Lakes':
        ...
        great_lakes = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])]
    ...
    if run_name == 'Gulf Coast':
        ...
        gulf_coast = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])]
    ...
    if run_name == 'Mississippi':
        ...
        mississippi = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])|
        (flowlines['HUC2'] == major_basins[run_name][1]) |
        (flowlines['HUC2'] == major_basins[run_name][2]) |
        (flowlines['HUC2'] == major_basins[run_name][3]) | 
    ...
    if run_name == 'North Atlantic':
        ...
        north_atlantic = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])|
        (flowlines['HUC2'] == major_basins[run_name][1])]
    ...
    if run_name == 'Red':
        ...
        red = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])]
    ...
    if run_name == 'Rio Grande':
        ...
        rio_grande = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])]
    ...
    if run_name == 'South Atlantic':
        ...
        south_atlantic = flowlines.loc[(flowlines['HUC2'] == major_basins[run_name][0])]
